...
#define LOG(fmt, ...) ::corehost::log::core_log(L"%-35hs " fmt L"\n", __func__, ##__VA_ARGS__)
...
#define LOG_HEX(tag, data, size) ::corehost::log::core_log_hex(__func__, tag, data, size)
...
#define LOG2(fmt, ...) ::corehost::log::core_log(L"%-35hs " fmt L"\n", __func__, ##__VA_ARGS__)
...
#define LOG2_HEX(tag, data, size) ::corehost::log::core_log_hex(__func__, tag, data, size)
...
#define LOG3(fmt, ...) ::corehost::log::core_log(L"%-35hs " fmt L"\n", __func__, ##__VA_ARGS__)
...
#define LOG3_HEX(tag, data, size) ::corehost::log::core_log_hex(__func__, tag, data, size)
