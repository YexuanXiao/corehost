...
void append_text(winrt_xml::XmlDocument const &xml, winrt_xml::XmlElement const &binding, std::wstring_view text)
{
...
void send(std::wstring_view title, std::wstring_view body, const action *action_button) noexcept
{
    try
    {
